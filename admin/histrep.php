...
//session_start();
include("connect.php");
$result = mysqli_query($con,"SELECT * FROM Update_History");
$result2 = mysqli_query($con,"SELECT * FROM Login_History");
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#lo">Logged in As     <?php echo $_SESSION["Admin_ID"]; ?></a></li>
