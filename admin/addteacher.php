...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $query="INSERT INTO Teacher(`Teacher_ID`,`FName`,`MName`,`LName`,`Designation`,`Dep_ID`,`HOD_ID`,`Password`) VALUES('$S_ID','$FN','$MN','$LN','$DESG','$DEPTID','$HOD_ID','$PASSWD')";    
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
		...
		<form class="form" action="" method="POST">
			...
			<button name="save" type="submit" id="sub">Proceed</button>
		</form>
	 </div>
