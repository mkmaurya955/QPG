 ...
 if(isset($_REQUEST['save']))
{
    if(!isset($_REQUEST['subject'])){
	    ...
	    $query2="INSERT INTO  Course_Outcome VALUES('$CID','2','$co2')";   
	    $res2=mysqli_query($con,$query2);
	    $query3="INSERT INTO  Course_Outcome VALUES('$CID','3','$co3')";   
	    $res3=mysqli_query($con,$query3);
		$query4="INSERT INTO  Course_Outcome VALUES('$CID','4','$co4')";   
	    $res4=mysqli_query($con,$query4);
		$query5="INSERT INTO  Course_Outcome VALUES('$CID','5','$co5')";   
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="facultydash.php">Logged in As     <?php echo $_SESSION["Admin_ID"]; ?></a></li>
